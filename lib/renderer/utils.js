 ...
 * @returns {Number}
 */
const getScale = function (qrSize, opts) {
 ...
 * @returns {Number}
 */
const getImageWidth = function (qrSize, opts) {
 ...
 * @returns {*} imgData
 */
const qrToImageData = function (imgData, qr, opts) {
...
module.exports = {getOptions, getScale, getImageWidth, qrToImageData, escapeHtml, encodeUrl, getOptions}